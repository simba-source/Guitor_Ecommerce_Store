-- create sample user (10-digit id)
...
-- create sample transaction (15-digit id)
--(sample user buys a Gibson F-25 at the last second of xmas eve of '65)
INSERT INTO PURCHASE VALUES (480927289170066, 0123456789, 3836594, 1965-12-24 11:59:59);